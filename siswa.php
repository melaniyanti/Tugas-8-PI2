...
<div class="container">
        ...
        <br>
        <a href="create_siswa.php"><input type="button" value="Tambah Data"></a>
        <a href="print_siswa.php" target="_blank"><input type="button" value="Cetak Data"></a>
        <br><br>
                    ...
                    foreach ($result as $data) : ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a name="edit" id="edit" href="edit_siswa.php?id=<?= $data->id_siswa ?>"><input type="button" value="Edit"></a>
                                <a name="hapus" id="hapus" href="proses.php?siswa_id=<?= $data->id_pjm ?>"><input type="button" value="Delete"></a> 
                            </td>
                        </tr>
                    <?php endforeach;
                } else { ?>
