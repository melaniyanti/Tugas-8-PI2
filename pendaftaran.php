...
<div class="container">
        <h1 align="center">Data Pendaftaran</h1>
        <br>
        <a href="create_pendaftaran.php"><input type="button" value="Tambah Data"></a>
        <a href="print_pendaftaran.php" target="_blank"><input type="button" value="Cetak Data"></a>
        <br><br>
                ...
                if (!empty($result)) {
                    foreach ($result as $data) : ?>
                        <tr>
                            ...
                            <td>
                                <a name="edit" id="edit" href="edit_pendaftaran.php?id=<?= $data->id_pendaftaran ?>"><input type="button" value="Edit"></a>
                                <a name="hapus" id="hapus" href="proses.php?pendaftaran_id=<?= $data->id_pendaftaran ?>"><input type="button" value="Delete">
                                </a>
                            </td>
                        </tr>
                    <?php endforeach;
